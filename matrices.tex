...
\begin{document}
	...
	\end{align*}
	% TODO give a tensor product form for the Hadamard matrix
	...
	% TODO the sign (-1)^{a(aS + a)^T} has been added 
	% TODO correct the notations, use bold for matrices and vectors as above
